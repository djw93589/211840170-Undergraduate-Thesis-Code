...
save_root = '../../data/PneumoniaMNIST/images'
dataset = PneumoniaMNIST(split='train', download=True) + PneumoniaMNIST(split='test', download=True)
...
for i in tqdm(range(len(dataset))):
    ...
    full_path = os.path.relpath(save_path, start='../../data/PneumoniaMNIST/images').replace('\\', '/')
    ...
    # 写入CUB风格的 txt 文件
    with open('../../data/PneumoniaMNIST/images.txt', 'w') as f:
        f.write('\n'.join(images_txt))
    with open('../../data/PneumoniaMNIST/image_class_labels.txt', 'w') as f:
        f.write('\n'.join(labels_txt))
    with open('../../data/PneumoniaMNIST/train_test_split.txt', 'w') as f:
        f.write('\n'.join(split_txt))
    with open('../../data/PneumoniaMNIST/bounding_boxes.txt', 'w') as f:
        f.write('\n'.join(bbox_txt))
    with open('../../data/PneumoniaMNIST/classes.txt', 'w') as f:

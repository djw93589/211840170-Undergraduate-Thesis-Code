...
save_root = '../../data/DermaMNIST/images'
dataset = DermaMNIST(split='train', download=False) + DermaMNIST(split='test', download=False)
...
for i in tqdm(range(len(dataset))):
    ...
    full_path = os.path.relpath(save_path, start='../../data/DermaMNIST/images').replace('\\', '/')
    ...
    # 写入CUB风格的 txt 文件
    with open('../../data/DermaMNIST/images.txt', 'w') as f:
        f.write('\n'.join(images_txt))
    with open('../../data/DermaMNIST/image_class_labels.txt', 'w') as f:
        f.write('\n'.join(labels_txt))
    with open('../../data/DermaMNIST/train_test_split.txt', 'w') as f:
        f.write('\n'.join(split_txt))
    with open('../../data/DermaMNIST/bounding_boxes.txt', 'w') as f:
        f.write('\n'.join(bbox_txt))
    with open('../../data/DermaMNIST/classes.txt', 'w') as f:

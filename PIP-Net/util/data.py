...
def get_data(args: argparse.Namespace):
    ...
    if args.dataset =='CUB-200-2011':     
        return get_birds(True, '../data/CUB_200_2011/dataset/train_crop',
                         '../data/CUB_200_2011/dataset/train', '../data/CUB_200_2011/dataset/test_crop', args.image_size, args.seed, args.validation_size,
                         '../data/CUB_200_2011/dataset/train', '../data/CUB_200_2011/dataset/test_full')
    if args.dataset == 'pets':
        return get_pets(True, '../data/data/PETS/dataset/train', '../data/data/PETS/dataset/train',
                        '../data/data/PETS/dataset/test', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'partimagenet': #use --validation_size of 0.2
        return get_partimagenet(True, '../data/data/partimagenet/dataset/all', '../data/data/partimagenet/dataset/all', None, args.image_size, args.seed, args.validation_size)
    if args.dataset == 'CARS':
        return get_cars(True, '../data/data/cars/dataset/train', '../data/data/cars/dataset/train',
                        '../data/data/cars/dataset/test', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'grayscale_example':
        return get_grayscale(True, '../data/data/train', '../data/data/train', '../data/data/test', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'retinamnist':
        return get_retinamnist(True, '../data/RetinaMNIST/dataset/train', '../data/RetinaMNIST/dataset/train',
                               '../data/RetinaMNIST/dataset/test_full', args.image_size, args.seed,
                               args.validation_size)
    if args.dataset == 'pathmnist':
        return get_pathmnist(True, '../data/PathMNIST/dataset/train', '../data/PathMNIST/dataset/train',
                             '../data/PathMNIST/dataset/test_full', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'dermamnist':
        return get_dermamnist(True, '../data/DermaMNIST/dataset/train', '../data/DermaMNIST/dataset/train',
                              '../data/DermaMNIST/dataset/test_full', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'organcmnist':
        return get_organcmnist(True, '../data/OrganCMNIST/dataset/train', '../data/OrganCMNIST/dataset/train',
                              '../data/OrganCMNIST/dataset/test_full', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'octmnist':
        return get_octmnist(True, '../data/OCTMNIST/dataset/train', '../data/OCTMNIST/dataset/train',
                            '../data/OCTMNIST/dataset/test_full', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'pneumoniamnist':
        return get_pneumoniamnist(True, '../data/PneumoniaMNIST/dataset/train', '../data/PneumoniaMNIST/dataset/train',
                                  '../data/PneumoniaMNIST/dataset/test_full', args.image_size, args.seed,
                                  args.validation_size)
    if args.dataset == 'organamnist':
        return get_organamnist(True, '../data/OrganAMNIST/dataset/train', '../data/OrganAMNIST/dataset/train',
                               '../data/OrganAMNIST/dataset/test_full', args.image_size, args.seed,
                               args.validation_size)
    if args.dataset == 'ChestXray':
        return get_ChestXray(True, '../data/ChestXray3/dataset/train', '../data/ChestXray3/dataset/train',
                             '../data/ChestXray3/dataset/test_full', args.image_size, args.seed, args.validation_size)
    if args.dataset == 'KneeXray1':
        return get_KneeXray(True, '../data/KneeXray/MedicalExpert-1/dataset/train',
                            '../data/KneeXray/MedicalExpert-1/dataset/train',
                            '../data/KneeXray/MedicalExpert-1/dataset/test_full', args.image_size, args.seed,
                            args.validation_size)
    if args.dataset == 'KneeXray2':
        return get_KneeXray(True, '../data/KneeXray/MedicalExpert-2/dataset/train',
                            '../data/KneeXray/MedicalExpert-2/dataset/train',
                            '../data/KneeXray/MedicalExpert-2/dataset/test_full', args.image_size, args.seed,
                            args.validation_size)
...
def get_dataloaders(args: argparse.Namespace, device):
    ...
    #如果要做类别不平衡加权，就根据训练子集train_indices里的标注计算采样权重，
    # 并用 WeightedRandomSampler 构造平衡抽样；否则走普通shuffle。
...
def get_retinamnist(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
...
def get_pathmnist(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
                  validation_size: float):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
...
def get_dermamnist(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
                   validation_size: float):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
...
def get_organcmnist(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
                    validation_size: float):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
...
def get_octmnist(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
             validation_size: float):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
...
def get_pneumoniamnist(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
             validation_size: float):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
...
def get_organamnist(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
             validation_size: float):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
...
def get_ChestXray(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
...
def get_KneeXray(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size: int, seed: int,
                 validation_size: float, train_dir_pretrain=None, test_dir_projection=None):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)

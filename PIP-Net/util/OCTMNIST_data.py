...
save_root = '../../data/OCTMNIST/images'
...
for i in tqdm(range(len(dataset))):
    ...
    full_path = os.path.relpath(save_path, start='../../data/OCTMNIST/images').replace('\\', '/')
    ...
    # 写入CUB风格的 txt 文件
    with open('../../data/OCTMNIST/images.txt', 'w') as f:
        f.write('\n'.join(images_txt))
    with open('../../data/OCTMNIST/image_class_labels.txt', 'w') as f:
        f.write('\n'.join(labels_txt))
    with open('../../data/OCTMNIST/train_test_split.txt', 'w') as f:
        f.write('\n'.join(split_txt))
    with open('../../data/OCTMNIST/bounding_boxes.txt', 'w') as f:
        f.write('\n'.join(bbox_txt))
    with open('../../data/OCTMNIST/classes.txt', 'w') as f:

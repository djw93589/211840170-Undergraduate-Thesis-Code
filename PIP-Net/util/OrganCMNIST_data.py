...
save_root = '../../data/OrganCMNIST/images'
dataset = OrganCMNIST(split='train', download=True) + OrganCMNIST(split='test', download=True)
...
for i in tqdm(range(len(dataset))):
    ...
    full_path = os.path.relpath(save_path, start='../../data/OrganCMNIST/images').replace('\\', '/')
    ...
    # 写入CUB风格的 txt 文件
    with open('../../data/OrganCMNIST/images.txt', 'w') as f:
        f.write('\n'.join(images_txt))
    with open('../../data/OrganCMNIST/image_class_labels.txt', 'w') as f:
        f.write('\n'.join(labels_txt))
    with open('../../data/OrganCMNIST/train_test_split.txt', 'w') as f:
        f.write('\n'.join(split_txt))
    with open('../../data/OrganCMNIST/bounding_boxes.txt', 'w') as f:
        f.write('\n'.join(bbox_txt))
    with open('../../data/OrganCMNIST/classes.txt', 'w') as f:
